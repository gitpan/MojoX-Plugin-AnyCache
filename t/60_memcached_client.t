...
$cache->register(FakeApp->new, { backend => 'MojoX::Plugin::AnyCache::Backend::Memcached::Client', %opts });
isa_ok $cache->backend, 'MojoX::Plugin::AnyCache::Backend::Memcached::Client';
